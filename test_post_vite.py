...
with sync_playwright() as p:
    ...
    if files:
        ...
        page.screenshot(path="post_vite_2d.png")
        print("Screenshot post vite config saved for 2D mode.")
        ...
        if mpr_btn.is_visible():
            mpr_btn.click()
            page.wait_for_timeout(5000)
            page.screenshot(path="post_vite_mpr.png")
            print("Screenshot post vite config saved for MPR mode.")
