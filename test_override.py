...
with sync_playwright() as p:
    ...
    if files:
        ...
        page.screenshot(path="override_2d.png")
        print("Screenshot override saved for 2D mode.")
        ...
        if mpr_btn.is_visible():
            mpr_btn.click()
            page.wait_for_timeout(5000)
            page.screenshot(path="override_mpr.png")
            print("Screenshot override saved for MPR mode.")
